...
class Calculator{
    ...
    init(){
        ...
        addGroup(group: Groups(groupName: "Physics", functions: [Functions(functionName: "Force", formula: "mass * accleration = Force", variables: ["mass", "acceleration","Force"]),Functions(functionName: "Speed", formula: "Distance/Time=Speed", variables: ["distance","time","Speed"]),Functions(functionName: "Kinetic Energy", formula: "(mass * velocity)/2", variables: ["mass","velocity","Kinetic Energy"])]))
        addGroup(group: Groups(groupName: "Chemistry", functions: [Functions(functionName: "Atomic Number", formula: "number of protons + number of nuetrons=Atomic Number", variables: ["protons","neutrons","Atomic Number"]),Functions(functionName: "Mass Number",formula: "Number of protons + number of Neutrons=Mass Number", variables: ["protons", "neutrons","Mass Number"]),Functions(functionName: "K20",formula: " ", variables: []),Functions(functionName: "Li",formula: " ", variables: [])]))
